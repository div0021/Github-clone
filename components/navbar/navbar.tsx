      ...
      <div className="text-white bg-transparent py-5">
        <div className="flex items-center max-lg:flex-row-reverse max-lg:justify-between">
          <div className="flex justify-between items-center max-lg:w-full">
            ...
            >
              <div
                className={`w-[23px] h-[2px] transititon ease-in duration-150 bg-white ${
                  showNav ? "rotate-45 translate-y-[1px]" : "rotate-0"
                }`}
              ></div>
          ...
          <div
            className={`flex w-full max-lg:absolute transition ease-in duration-150 top-16 z-40 ${
              showNav
          ...
          >
            <div className="flex max-lg:flex-col lg:items-center max-sm:w-10/12 max-sm:mx-auto sm:ml-auto max-lg:w-[320px] lg:w-full max-lg:max-h-[500px] overflow-y-auto lg:mb-0 max-lg:bg-white max-lg:rounded-lg lg:justify-between">
              <nav className="mt-0 px-3 lg:px-6 text-[15.5px] mb-0 max-lg:py-10 max-lg:px-5">
                <ul className="flex lg:items-center lg:space-x-2 max-lg:flex-col max-lg:text-neutral-700 max-lg:text-xl max-lg:font-medium max-lg:space-y-6 max-lg:h-auto overflow-y-auto">
                  ...
                  <li>
                    <Link
                      href=""
                      className="max-lg:font-semibold flex items-center p-1 hover:text-neutral-500"
                    >
                      Pricing
                    </Link>
                  </li>
              ...
              <div className="lg:flex items-center max-lg:flex-col lg:px-0 px-3 mb-3 lg:mb-0 text-left max-lg:space-y-3 lg:space-x-4">
