            ...
            <div className="py-4 mb-2 w-full">
                 ...
                 <h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full text-[#7d8590]">
                  ...
                  Github CodeSpaces 
                    ...
                    offers a complete dev environment in seconds, so you can code, build, test, and open pull requests from any repo anywhere.
                 </h2>
            ...
            <div className="py-4 px-6 w-full">
                <div className="relative">
                    <div className="flex flex-row relative">
                      ...
                      transition={{delay:0.2,type:"tween"}}
                      className="z-[1] top-[-200px] right-7 shadow-2xl sm:absolute"
                      >
                          <Image src="/pic.png" alt="mui"  loading="lazy" decoding="async" 
                          width={300}
                          height={280} className=" w-[300px] h-auto rounded-md" />
                            <Image
