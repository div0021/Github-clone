...
import CopiloteFeature from "./copilotefeature";
      ...
      <div className="flex md:pl-10 space-x-3 md:space-x-10">
        <div className="flex flex-col items-center">
          ...
          <motion.div
            ...
            className="h-full w-[3px] max-md:w-[2px] mt-7 rounded-md bg-gradient-to-b from-[#7ee787]"
          ></motion.div>
        </div>
        <div className="md:w-10/12 mb-24">
          <motion.div
            className="text-xl md:text-2xl mb-7 font-medium text-white"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 1, delay: 0.4 }}
            viewport={{ once: false }}
          ...
          <motion.div
            ...
            viewport={{ once: false }}
            className="text-3xl md:text-[48px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 text-white font-medium"
          >
      ...
      <div className="flex justify-between md:space-x-10 max-md:flex-col">
        <HoverCard backgroundColor="#7ee787" direction="flex-col" left="0" >
          <div className="md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pr-32">
           ...
           <div>
            <Link href="" onMouseEnter={() => setHovered(true)} onMouseLeave={()=>setHovered(false)} className="md:text-xl text-white font-semibold inline-block">
        ...
        <HoverCard backgroundColor='#7ee787' direction='flex-col' left='-400px'>
                    <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        ...
                        <div>
                            <Link onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="" className=' md:text-xl text-white font-semibold inline-block'>
                                Get GitHub Mobile
